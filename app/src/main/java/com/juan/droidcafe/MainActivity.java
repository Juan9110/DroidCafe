...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(EXTRA_MESSAGE, mOrderMensaje);
    ...
    public void showDonutOrder(View view) {
        ...
        mOrderMensaje = getString(R.string.donut_order_message);
        displayToast(mOrderMensaje);

    }

    public  void showIceCreamOrder(View view){
       displayToast(getString(R.string.ice_cream_order_message));
       mOrderMensaje = getString(R.string.ice_cream_order_message);
       displayToast(mOrderMensaje);
    }
    public void showFroyoOrder(View view){
        displayToast(getString(R.string.froyo_order_message));
        mOrderMensaje = getString(R.string.froyo_order_message);
        displayToast(mOrderMensaje);
    }
